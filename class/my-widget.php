...
class olbWidgetMembersMenu extends WP_Widget {
	...
	function olbWidgetMembersMenu() {
		...
		parent::WP_Widget(false, $name=__('Members only', OLBsystem::TEXTDOMAIN), $widget_option, $control_option);
	}
...
class olbWidgetTeachersMenu extends WP_Widget {
	...
	function olbWidgetTeachersMenu() {
		$widget_option = array('description' => __('This block is displayed while teacher logged in.',OLBsystem::TEXTDOMAIN));
		$control_option = array('width' => 400, 'height' => 350);
		parent::WP_Widget(false, $name=__('Teachers only', OLBsystem::TEXTDOMAIN), $widget_option, $control_option);
	}
	function widget($args, $instance) {
		global $olb;
...
class olbWidgetAdminsMenu extends WP_Widget {
	...
	function olbWidgetAdminsMenu() {
		$widget_option = array('description' => __('This block is displayed while administrator logged in.',OLBsystem::TEXTDOMAIN));
		$control_option = array('width' => 400, 'height' => 350);
		parent::WP_Widget(false, $name=__('Admins only', OLBsystem::TEXTDOMAIN), $widget_option, $control_option);
	}
	function widget($args, $instance) {
		global $olb;
