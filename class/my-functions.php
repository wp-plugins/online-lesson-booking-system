...
class olbInitFunction {
	 ...
	 */
	public function hideMenuAdminpage(){
	...
	public function init(){
		...
		add_action('profile_update', array('olbHookAction', 'inUpdateProfile'));
		add_action('delete_user', array('olbHookAction', 'inDeleteUser'));
		add_action('parse_request', array('olbHookAction', 'inSpecialPageAccess'), 10);
		add_action('parse_request', array('olbHookAction', 'formAction'), 11);
